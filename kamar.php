            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="section_title text-center mb-100">
                        <h3>Pilihan Kamar Mettbrand Hotel</h3>
                    </div>
                </div>
            </div>
        </div>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> Mettbrand Hotel<i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">Noufal Mulki</a>
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                        </p>
                    </div>
                        ...
                        <div class="popup_inner">
                            ...
                            <form >
                                <div class="row">
                                    ...
                                    <div class="col-xl-6">
                                        <input id="datepicker" name ="cekin"placeholder="Tanggal Check in">
                                    </div>
                                    <div class="col-xl-6">
                                        <input id="datepicker2" name = "cekout"placeholder="Tanggal Check out ">
                                    </div>
                                    <div class="col-xl-12">
                                        <input class = "form-control" type="number" name="jumlah" placeholder="Masukan Jumlah Kamar">
                                    </div>
                                    ...
                                    <div class="col-xl-12">
                                       <select class="form-select wide" name="room_tipe" id="default-select" class="">
                                            <option data-display="---Pilih Kamar---">---Pilih Kamar---</option>
