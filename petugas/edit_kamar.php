            ...
            <div class="card card-primary">
              ...
              <form action ="simpan_edit.php" method ="post" autocomplete="off" enctype="multipart/form-data">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                   ...
                   <div class="form-group">
                    ...
                    <input type="number" name="jumlah_kamar" class="form-control" id="exampleInputPassword1" value= " <?php echo $data['jumlah_kasur'];?>">
                  </div>
                  <div class="form-group">
                ...
                <div class="form-group">
                    <div class="input-group">
                      <div class="custom-file">
                      <img src="../img/<?php echo $data["gambar_kamar"];?>" width = 150 title="<?php echo $data['gambar_kamar']; ?>">
                      </div>
                    </div>
                  </div>
